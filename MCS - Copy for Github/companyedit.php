...
<?php
    ...
    {	
        ...
        //updating the table
        $result = mysqli_query($conn, "UPDATE company SET cname='$cname' WHERE id=$id");
...
<?php
    ...
    $result = mysqli_query($conn, "SELECT * FROM company WHERE id=$id");
...
<html>
    ...
    <body>
        ...
        <div class="container col-5" style="background-color: #EAEAEA; border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px; margin-top: 120px;">
            <br>
            <div class="container">
                <center><h3 style="font-family:Trebuchet MS;">Edit Company</h3></center>
            </div>
            <br>
            <form action="companyedit.php" method="post">
                <div class="form-group col-md-12">
                    <label for="inputPassword4">Company Name:</label>
                    <input name="cname" type="text" class="form-control" value="<?php echo $cname;?>" style="text-transform:uppercase;" required>
                </div>
                <div class="form-group col-md-12">
